...
import pic from './images/main-page.JPG'
    ...
    <div className='py-4 px-24'>
        <div className='md:grid md:grid-cols-2 py-10 gap-4'>
          <div className='md:col-span-2 md:text-7xl '>
            <p className="text-blue-800 p-5 relative top-[6px] right-4 inline-block">
              ...
              <span className={kan.className}>find the best <br /> doctors for your dental <br /> surgery</span>
            </p>
          </div>
        ...
        <div className='flex gap-8 py-10 w-[1131px]'>
          <div className='bg-indigo-300 grid justify-center items-center text-center h-[40vh] container hover:shadow-2xl hover:ease-in duration-300'>
          ...
          <div className='bg-teal-300 grid justify-center items-center text-center h-[40vh] container hover:shadow-2xl hover:ease-in duration-300'>
            <div className='space-y-5 px-3'>
          ...
          <div className='bg-lime-200 grid justify-center items-center text-center h-[40vh] container hover:shadow-2xl hover:ease-in duration-300'>
            <div className='space-y-5 px-3'>
          ...
          <div className='bg-rose-200 grid justify-center items-center text-center h-[40vh] container hover:shadow-2xl hover:ease-in duration-300'>
            <div className='space-y-5 px-3'>
        ...
        <div className='grid grid-cols-2 grid-rows-2 pt-24 w-[1131px] gap-7'>
          <div >
